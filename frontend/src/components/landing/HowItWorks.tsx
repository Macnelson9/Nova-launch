...
export function HowItWorks() {
  return (
    <section id={LANDING_SECTION_IDS.howItWorks} className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <PillTag tone="neutral">How It Works</PillTag>
      <h2 className="mt-3 text-3xl font-bold text-gray-900">Three steps from idea to live token</h2>
