...
export function Features() {
  return (
    <section id={LANDING_SECTION_IDS.features} className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <PillTag tone="neutral">Features</PillTag>
      <h2 className="mt-3 text-3xl font-bold text-gray-900">Everything needed for token deployment</h2>
